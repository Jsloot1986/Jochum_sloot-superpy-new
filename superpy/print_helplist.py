...
def print_helplist():
    ...
    print("Every argument should be preceded by the call on the program : py main.py")
    print("")
    ...
    console.print(
        "For details on functional specifications please read readme or the manual ", style="red on white")
